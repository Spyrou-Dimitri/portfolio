...
namespace Portfolio_Theme\Forms;
...
class ContactForm
{
    ...
    public function handle(array $data): void
    {
        ...
        wp_insert_post([
            ...
            'post_title' => $data['firstname'].' '.$data['lastname'].' - '.$data['object'],
    ...
    protected function generateEmailContent(array $data): string
    {
        return 'Bonjour,'.PHP_EOL
            ...
            .'------'.PHP_EOL
            .$data['object'].PHP_EOL.PHP_EOL
            .$data['message'].PHP_EOL.PHP_EOL
            .'------'.PHP_EOL
            .'Adresse mail: '.$data['email'].PHP_EOL.PHP_EOL
